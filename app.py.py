...
st.set_page_config(layout='wide') #para configurar la página que me aproveche todo el ancho

st.markdown("<h1 style='text-align: center; color:#1687CE; '> Histórico de disparos en Nueva York 🗽💥🔫 </h1>", unsafe_allow_html=True)
#Color html para buscar otro codigo de colores en internet
...
#--------------------------------------------------------------------
c1, c2 =st.columns((1,1)) #para indicar que son dos columnas de = tño 

c1.markdown("<h3 style='text-align: center; color:#1687CE; '> ¿Dónde han ocurrido disparos en Nueva York? </h3>", unsafe_allow_html=True)
...
c2.markdown("<h3 style='text-align: center; color:#1687CE; '> ¿A qué hora ocurren disparos en Nueva York? </h3>", unsafe_allow_html=True)
...
st.markdown("<h3 style='text-align: center; color:#1687CE; '> ¿Cómo ha sido la evolución de disparos por barrio en Nueva York? </h3>", unsafe_allow_html=True)
...
df2['vic_age_group'] = df2['perp_age_group'].replace({'940':'N/A','224':'N/A',
                                                       '1020':'N/A','UNKNOWN':'N/A'})
...
fig=px.pie(df2, values='incident_key', names='perp_sex', width=330, height=330)
...
fig=px.pie(df2, values='incident_key', names='vic_sex', width=330, height=330)
...
#TAREA: poner el parametro para especificar los colores de cada categoría
